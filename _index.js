    ...
    service.init(() => {
        bl.init(service, config, (error) => {
            ...
            service.get("/user", function (req, res) {
                req.soajs.inputmaskData.keep = {"allowedTenants": true};
            ...
            service.put("/admin/account/password", function (req, res) {
                bl.admin_changePassword(req.soajs, req.soajs.inputmaskData, null, (error, data) => {
                    return res.json(req.soajs.buildResponse(error, data));
                });
            });
            ...
            */
            ...
            service.post("/admin/group/tenant", function (req, res) {
                bl.group.add(req.soajs, req.soajs.inputmaskData, null, (error, data) => {
                    return res.json(req.soajs.buildResponse(error, data));
                });
            });

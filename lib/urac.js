...
module.exports = {
	...
	"init": function (options, cb) {
		...
		let mainTenantModel = require (__dirname + "/../model/user.js");
		let tenantModel =  require (__dirname + "/../model/group.js");
				account.model = mainTenantModel;
				guest.model = mainTenantModel;
				user.model = mainTenantModel;
				group.model = tenantModel;
				token.model = mainTenantModel;
				
				libProduct.model = mainTenantModel;
